        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="">OPERARIO - ACTIVIDADES</a>
                </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <form action="" method="POST">
                                                ...
                                                <div class="header">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-3">
                                                            <h4>Tarea Inmediata:</h4>
                                                        </div>
                                                        <div class="col-xs-6">
                                                            <select class="form-control" id="" name="Sede">
                                                        ...
                                                        <div class="col-xs-3">
                                                            <div align="center">
                                                                <button style="width: 138px; height: 39px;"name="" class="btn bg-indigo waves-effect">Realizar Consulta</button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-3">
                                                            <div align="center">
                                                                <button style="width: 138px; height: 39px;" name="" class="btn bg-indigo waves-effect">  Entregar Turno  </button>
                                                            </div>
                                                        </div>
