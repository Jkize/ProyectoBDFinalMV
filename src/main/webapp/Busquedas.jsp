                        ...
                        <section class="content">
                                            ...
                                            <form action="ServletBusquedas" method="POST">
                                                ...
                                                <div class="header">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-3">
                                                            <h5>Empresa</h5>
                                                            <select class="form-control" id="select1" name="Empresa">
                                                                <option value="">Seleccionar</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-xs-3">
                                                            <h5>Sede</h5> 
                                                            <select class="form-control" id="select2" name="Sede">
                                                                <option value="">Seleccionar</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-xs-3">
                                                            <h5>Servidor</h5>
                                                            <select class="form-control" id="select3" name="Servidor">
                                                                <option value="">Seleccionar</option>
                                                            </select> 
                                                        </div>
                                                        <div class="col-xs-3">
                                                            <br><br><br><br>
                                                            <div align="center">
                                                                <button name="consulta" class="btn bg-indigo waves-effect">Realizar Consulta</button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-3">
                                                            <h5>Categoría</h5> 
                                                            <select class="form-control" id="select4" name="Categoria">
                                                                <option value="">Seleccionar</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-xs-3">
                                                            <h5>Fecha</h5> 
                                                            <input class="form-control" style="width: 100%" name="fecha1" type="date" id="fecha1" size="10">
                                                        </div>
                                                        <div class="col-xs-3">
                                                            <h5>Operador</h5> 
                                                            <select class="form-control" id="select6" name="Operador">
                                                                <option value="">Seleccionar</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-xs-3">
                                                            ...
                                                            if(request.getAttribute("todo")!=null){
                                                              List<Object> todo=(List<Object>)request.getAttribute("todo");                            
                                                               ...
                                                               if(todo.size()>5){
                                                                   ...
                                                                   List<String> filtro=(List<String>)todo.get(5);
                                                                     
                                                                    for(int i=0; i<filtro.size(); i++){

                                                                         String aux[]=filtro.get(i).split(",");
                            ...
                            <%
                                 if(request.getAttribute("todo")!=null){
                                     ...
                                     List<Servidor> servidores = (List<Servidor>) todo.get(1);
                                     List<Categoria> categorias = (List<Categoria>) todo.get(2);
                                     List<Sede> sedes = (List<Sede>) todo.get(3);
                                     List<Empleado> empleados = (List<Empleado>) todo.get(4);
                                     String h;
                            ...
                            <script>
                               ...
                               for (int i = 0; i < categorias.size(); i++) { 
                                   h=categorias.get(i).getCodigo()+" "+categorias.get(i).getNombre();
                                %>
                                option = document.createElement("option");
                                option.value = "<%=h%>";
                                option.text = "<%=h%>";
                            ...
                            <script>
                               ...
                               for (int i = 0; i < servidores.size(); i++) { 
                                   h=servidores.get(i).getCodigo()+" "+servidores.get(i).getNombre();
                                %>
                                option = document.createElement("option");
                                option.value = "<%=h%>";
                                option.text = "<%=h%>";
                            ...
                            <script>
                                ...
                                for (int i = 0; i < empleados.size(); i++) { 
                                    h=empleados.get(i).getCorreo()+" "+empleados.get(i).getNombre();
                                %>
                                option = document.createElement("option");
                                option.value = "<%=h%>";
                                option.text = "<%=h%>";
